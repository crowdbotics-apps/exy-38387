"""
Django settings for exy_38387 project.
...
WSGI_APPLICATION = 'exy_38387.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "exy_38387 API",
    "DESCRIPTION": "API documentation for exy_38387 App",
    "VERSION": "v1",
}
